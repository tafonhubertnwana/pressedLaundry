  ...
  <div className="grid lg:grid-cols-2 gap-8">
    ...
    <div className="flex flex-col bg-slate-100 p-6 lg:p-8 rounded-lg shadow-md">
      <div className="content-center">
        ...
        <p className="py-2">
          You shouldn&rsquo;t have to tolerate late deliveries or low standards of work at high prices. Our comprehensive services include laundering, ironing, dry cleaning, shoe repairs, upholstery cleaning, and more, all designed to make your life easier.
        </p>
      </div>
    </div>
  </div>
